...
const int button1Pin = 15;  // MENU
const int button2Pin = 14;  // SELECT
const int button3Pin = 12;  // BACK
...
void loop() {
  ...
  if(!dead){
    ...
    if(poopometer>=10){
      int poopometer2=countPoops();
      poops[poopometer2]=random(20,display.width()+32);
      if(soundEnabled){
        tone(sound,200,50);
        noTone(sound);
      }

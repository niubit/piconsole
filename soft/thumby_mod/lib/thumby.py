...
mosi = machine.Pin(19)
sck = machine.Pin(18)
spi = machine.SPI(0, 100000, mosi=mosi, sck=sck)


# Pin definitions for button inputs & buzzer.
BUTTON_L = 13 # D-pad left
BUTTON_R = 12 # D-pad right
BUTTON_U = 15 # D-pad up
BUTTON_D = 14 # D-pad down
BUTTON_A = 11 # left (A) action button
BUTTON_B = 7  # right (B) action button
...
swBuzzer = machine.PWM(machine.Pin(10))
...
# Graphics instantiation I2C
#display = GraphicsClass(ssd1306.SSD1306_I2C(72, 40, i2c, res=machine.Pin(18)), 72, 40)

# Graphics instantiation SPI
display = GraphicsClass(ssd1306.SSD1306_SPI(DISPLAY_W, DISPLAY_H, spi, machine.Pin(16), machine.Pin(20), machine.Pin(17)), DISPLAY_W, DISPLAY_H)
